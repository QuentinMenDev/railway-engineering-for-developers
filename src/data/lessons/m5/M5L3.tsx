...
import { TractionPowerChain } from '../../../components/symbols';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M5L3({ goTo }: LessonProps) {
  return (
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <TractionPowerChain style={{ maxWidth: '340px' }} />
        </div>
        <figcaption>Schematic: Traction power chain — grid → feeder transformer → track switching → OLE → train.</figcaption>
      </figure>
      ...
      <figure className="lesson-figure">
        <div className="image-placeholder">
          <p>IMAGE NEEDED: Photo of a railway traction substation showing transformers, circuit breakers, and busbar equipment behind security fencing. Should convey the industrial scale of the power supply infrastructure.</p>
        </div>
        <figcaption>A traction feeder substation — the interface between the national electricity grid and the railway's overhead line.</figcaption>
      </figure>
