...
import { WheelProfile } from '../../../components/symbols';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M6L3({ goTo }: LessonProps) {
  return (
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <WheelProfile style={{ maxWidth: '280px' }} />
        </div>
        <figcaption>Schematic: Wheel profile — conical tread (1:20 taper) and flange on rail head. The taper provides kinematic steering.</figcaption>
      </figure>
      ...
      <figure className="lesson-figure">
        <div className="image-placeholder">
          <p>IMAGE NEEDED: Close-up photo or diagram of a railway wheel profile showing the conical tread taper, flange, and flange root. Ideally cross-sectional view showing how the wheel sits on the rail with the contact geometry visible.</p>
        </div>
        <figcaption>Cross-section of a railway wheel on a rail — the conical tread taper enables self-steering without any steering mechanism.</figcaption>
      </figure>
