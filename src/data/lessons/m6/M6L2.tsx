...
import { TractionPowerFlow } from '../../../components/symbols';
    ...
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <TractionPowerFlow style={{ maxWidth: '340px' }} />
        </div>
        <figcaption>Schematic: Traction power flow — 25 kV → transformer → inverter → motor → wheel. Regenerative braking reverses the flow.</figcaption>
      </figure>
      ...
      <figure className="lesson-figure">
        <div className="image-placeholder">
          <p>IMAGE NEEDED: Photo of a traction motor (AC induction type) either mounted in a bogie or on a test stand, showing the compact cylindrical motor and its mounting arrangement. Alternatively, an underfloor view of a modern EMU showing traction equipment.</p>
        </div>
        <figcaption>A modern AC induction traction motor — no brushes, no commutator, and almost no wearing parts.</figcaption>
      </figure>
