...
import { TunnelCrossSections } from '../../../components/symbols';
    ...
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <TunnelCrossSections style={{ maxWidth: '300px' }} />
        </div>
        <figcaption>Schematic: Tunnel cross-sections — circular bored (TBM) and rectangular cut-and-cover.</figcaption>
      </figure>
