...
import { BridgeTypes } from '../../../components/symbols';
    ...
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <BridgeTypes style={{ maxWidth: '340px' }} />
        </div>
        <figcaption>Schematic: Common bridge types — arch (compression), beam (bending), and box girder (torsional resistance).</figcaption>
      </figure>
