...
import { PlatformLayouts } from '../../../components/symbols';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M3L3({ goTo }: LessonProps) {
  return (
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <PlatformLayouts style={{ maxWidth: '340px' }} />
        </div>
        <figcaption>Schematic: Station platform layouts — side platforms, island platform, and bay platform (dead-end track).</figcaption>
      </figure>
