...
import { CantSuperelevation } from '../../../components/symbols';
    ...
    <>
      ...
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <CantSuperelevation style={{ maxWidth: '300px' }} />
        </div>
        <figcaption>Schematic: Cant (superelevation) — the outer rail is raised by distance D to counteract centrifugal force on curves.</figcaption>
      </figure>
