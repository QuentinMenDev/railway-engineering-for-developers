import { EtcsLevel2 } from '../../../components/symbols';
    ...
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <EtcsLevel2 style={{ maxWidth: '320px' }} />
        </div>
