import { AbsoluteBlockSection } from '../../../components/symbols';
import { Callout } from '../../components/Callout';
import { Connections } from '../../components/Connections';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M4L1({ goTo }: LessonProps) {
  return (
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <AbsoluteBlockSection style={{ maxWidth: '340px' }} />
        </div>
        <figcaption>Schematic: Absolute block — the line is divided into sections, each protected by signals. Only one train per section.</figcaption>
      </figure>
