import { PisDataFlow } from '../../../components/symbols';
import { Callout } from '../../components/Callout';
import { Connections } from '../../components/Connections';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M7L3({ goTo }: LessonProps) {
  return (
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <PisDataFlow style={{ maxWidth: '300px' }} />
        </div>
        <figcaption>Schematic: Passenger information — train data flows from Darwin to station CIS servers, then to displays, PA, and apps.</figcaption>
      </figure>
      ...
      <figure className="lesson-figure">
        <div className="image-placeholder">
          <p>IMAGE NEEDED: Photo of a modern railway station departure board (LED or LCD type) showing real-time train information, or a split image showing both a large concourse departure board and a platform indicator display.</p>
        </div>
        <figcaption>Station departure boards — the most visible output of the railway's passenger information system, driven by real-time train data.</figcaption>
      </figure>
