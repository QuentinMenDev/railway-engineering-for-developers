...
import { CuttingEmbankment } from '../../../components/symbols';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M2L2({ goTo }: LessonProps) {
  return (
    <>
      <figure className="lesson-figure">
        <div className="cad-symbol">
          <CuttingEmbankment style={{ maxWidth: '360px' }} />
        </div>
        <figcaption>Schematic: Cutting (excavated below ground) and embankment (filled above ground). OGL = original ground level.</figcaption>
      </figure>
