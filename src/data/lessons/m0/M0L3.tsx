...
import { StandardGauge } from '../../../components/symbols';
import type { LessonProps, QuizQuestion } from '../../../types';

export default function M0L3({ goTo }: LessonProps) {
  return (
    <>
      ...
      <figure className="lesson-figure">
        <div className="image-placeholder">
          <p>IMAGE NEEDED: Photo showing dual-gauge track (three rails on shared sleepers), or a gauge-change facility where two different track gauges meet. Illustrates how different gauges are physically incompatible.</p>
        </div>
        <figcaption>Track gauge — the railway's most fundamental interface specification. Different gauges are physically incompatible, like mismatched API versions.</figcaption>
      </figure>

      <figure className="lesson-figure">
        <div className="cad-symbol">
          <StandardGauge style={{ maxWidth: '300px' }} />
        </div>
        <figcaption>Schematic: Track gauge — the distance between inner rail faces. Standard gauge = 1,435 mm.</figcaption>
      </figure>
