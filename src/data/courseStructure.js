// Course structure: all 10 modules (0-9) are course modules with lessons
...
// Flat ordered list of all navigable page IDs
...
// Resolve module IDs (m0-m6) to first lesson
export function resolvePageId(pageId) {
  if (courseModules[pageId]) {
    return courseModules[pageId].lessons[0].id;
  }
  return pageId;
}
