...
interface SidebarProps {
  ...
  goTo: GoToFn;
  progress: Progress;
  isModuleComplete: (modId: string) => boolean;
  pct: number;
  totalDone: number;
  totalItems: number;
  isOpen: boolean;
...
export default function Sidebar({ currentPage, goTo, progress, isModuleComplete, pct, totalDone, totalItems, isOpen, onClose }: SidebarProps) {
